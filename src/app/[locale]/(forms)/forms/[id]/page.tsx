...
const TABS = ['submissions', 'emails', 'webhooks', 'settings'] as const
...
export default function FormDetailPage({ params }: FormDetailPageProps) {
  ...
  const currentTab = (searchParams.get('tab') as Tab) || 'submissions'
  ...
  const handleCopy = async () => {
    if (form) {
      await navigator.clipboard.writeText(form.endpoint)
      setCopied(true)
