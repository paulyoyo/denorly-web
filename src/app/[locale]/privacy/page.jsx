...
export default function PrivacyPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="prose prose-gray max-w-none space-y-8 text-gray-700 [&_h2]:mt-8 [&_h2]:mb-3 [&_h2]:text-xl [&_h2]:font-semibold [&_h2]:text-gray-900 [&_h3]:mt-4 [&_h3]:mb-2 [&_h3]:text-base [&_h3]:font-semibold [&_h3]:text-gray-800 [&_li]:mb-1 [&_p]:mb-3 [&_p]:text-sm [&_p]:leading-relaxed [&_ul]:mb-3 [&_ul]:list-disc [&_ul]:pl-5 [&_ul]:text-sm">
        {/* 1. Alcance */}
        <section>
          ...
          <p>
            ...
            sus usuarios, en cumplimiento de la Ley N° 29733 — Ley de Protección
            de Datos Personales del Perú — y su Reglamento aprobado mediante
        ...
        <section>
          ...
          <ul>
            <li>
              Enviar comunicaciones promocionales, novedades y actualizaciones
              de producto, siempre que el usuario haya otorgado su
              consentimiento. El usuario podrá revocar dicho consentimiento en
              cualquier momento.
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <ul>
            ...
            <li>Control de accesos basado en roles y autenticación segura.</li>
            <li>
        ...
        <section>
          ...
          <ul>
            ...
            <li>
              ...
              datos cuando haya finalizado la finalidad para la cual fueron
        ...
        <section>
          ...
          <ul>
            <li>Dirección: Calle Scipión Llona 350, Miraflores, Lima, Perú.</li>
            <li>
              Sitio web:{' '}
              <a
