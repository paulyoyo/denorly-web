...
function NavLinks({ navItems, pathname, onNavigate }) {
  return (
      ...
      <aside className="fixed inset-y-0 left-0 z-30 hidden w-64 bg-gray-800 md:block">
        ...
        <div className="absolute right-0 bottom-0 left-0 border-t border-gray-700 p-3">
          <button
            ...
            className="flex min-h-[44px] w-full items-center gap-3 rounded-lg px-3 py-2 text-sm text-gray-300 hover:bg-gray-700 hover:text-white"
          >
