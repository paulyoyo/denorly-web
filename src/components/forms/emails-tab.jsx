...
export function EmailsTab({ formId }) {
  ...
  const handleToggle = (templateId, enabled) => {
  ...
  const renderTemplateCard = (template, label) => {
      ...
      <Card>
        <CardBody>
          <div className="flex items-start justify-between">
            ...
            >
              {template.enabled ? (
                <ToggleRight className="text-primary-600 h-8 w-8" />
              ) : (
